...
public class MainActivity extends AppCompatActivity {
    ...
    void setUpImgDB(Config config) {
        // 이미지데이터베이스 생성
        AugmentedImageDatabase imageDatebase = new AugmentedImageDatabase(mSession);
        ...
        try {
            ...
            imageDatebase.addImage("bbb파일", bitmap);
            is.close();
            ...
            // 이미지데이터베이스에 bitmap 추가
            imageDatebase.addImage("qrqr", bitmap);
            Log.d("이미지 추가", "qr.png");
            is.close();*/
        ...
        // 이미지추적 활성화
        config.setAugmentedImageDatabase(imageDatebase);
    ...
    void drawImages(Frame frame) {
        ...
        Collection<AugmentedImage> updateAugmentedImages =
